...
class _MeetingState extends State<Meeting> {
  ...
  String subjectText =
      "Meet With Doctor"; //= TextEditingController(text: "My Plugin Test Meeting");
  ...
  void initState() {
    super.initState();
    roomText =
        "quvtiopxzphaadkjfbajjknjasdfjbasdf${widget.uid}${widget.doctid}";
  ...
  _joinMeeting() async {
    final serverUrl = serverText.text.trim().isEmpty ? null : serverText.text;
