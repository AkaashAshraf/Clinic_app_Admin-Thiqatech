...
class ChooseDeptClinicPage extends StatefulWidget {
  final cityId;
  final cityName;
  ChooseDeptClinicPage({this.cityId, this.cityName});
  @override
  _ChooseDeptClinicPageState createState() => _ChooseDeptClinicPageState();
}

class _ChooseDeptClinicPageState extends State<ChooseDeptClinicPage> {
  @override
