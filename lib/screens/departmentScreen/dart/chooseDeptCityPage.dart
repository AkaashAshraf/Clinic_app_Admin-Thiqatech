import 'package:demoadmin/screens/departmentScreen/dart/chooseDeptClinicPage.dart';
...
class ChooseDeptCityListPage extends StatefulWidget {
  @override
  _ChooseDeptCityListPagePageState createState() =>
      _ChooseDeptCityListPagePageState();
}

class _ChooseDeptCityListPagePageState extends State<ChooseDeptCityListPage> {
  @override
    ...
    return GestureDetector(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => ChooseDeptClinicPage(
