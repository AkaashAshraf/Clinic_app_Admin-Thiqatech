import 'package:demoadmin/screens/doctors/chooseDoctClinicPage.dart';
...
class ChooseDoctCityListPage extends StatefulWidget {
  @override
  _ChooseDoctCityListPageState createState() => _ChooseDoctCityListPageState();
}

class _ChooseDoctCityListPageState extends State<ChooseDoctCityListPage> {
  @override
    ...
    return GestureDetector(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => ChooseDoctClinicPage(
